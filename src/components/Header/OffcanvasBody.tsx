        ...
        <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-end flex-grow-1 pe-3 gap-2">
                <li className="nav-item d-flex align-items-center ">
                    ...
                    <Link className="nav-link active p-0 mx-1" to={`/${username}`}>Home</Link>
                </li>
                <li className="nav-item d-flex align-items-center ">
                    <span>
                    ...
                    <Link className="nav-link active p-0 mx-1"  to={`${username}/issues`}>Issues</Link>
                </li>
                <li className="nav-item d-flex align-items-center ">
                    <span>
                ...
                <li className="nav-item d-flex align-items-center ">
                    ...
                    <Link className="nav-link active p-0 mx-1"  to={`${username}/projects`}>Projects</Link>
                </li>
                <li className="nav-item d-flex align-items-center ">
                    <span>
            ...
            {displayedRepositories.map((repo)=> {
                return (
                    <li key={repo.id} className="d-flex align-items-center fs-md">
                        ...
                        <Link className="mx-2 text-reset text-decoration-none" to={`/${username}/${repo.name}`} >{username}/{repo.name}</Link>
                    </li>
                )
            })}
            </ul>
