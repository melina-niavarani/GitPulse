    ...
    <nav className="navbar ">
        <div className="container-fluid d-flex my-3">
            <div className="d-flex align-items-center gap-3">
                ...
                <span className="fw-bold">melina</span>
            </div>
            ...
            <div className="d-flex gap-4">
                ...
                <div className="d-flex gap-2">
                    <button id="global-create-menu-button" className="btn btn-outline-secondary btn-sm">  
                    ...
                    <a href="/issues" className="btn btn-outline-secondary btn-sm d-flex align-items-center">  
                        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" >
                            <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
                            <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
                        </svg>
                    </a>
                    <a href="/pulls" className="btn btn-outline-secondary btn-sm d-flex align-items-center">  
                        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" >
