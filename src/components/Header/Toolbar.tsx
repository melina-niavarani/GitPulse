    ...
    return(
        ...
        <nav aria-label="User" className="overflow-hidden">
            <ul className="list-style-none d-flex gap-4">
                <li className={`d-inline-flex  ${location.pathname === `/${username}/${repo_name}` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="overview-tab" to={`/${username}/${repo_name}`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center" >
                ...
                <li className={`d-inline-flex ${location.pathname === `/${username}/${repo_name}/issues` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="repositories-tab" to={`/${username}/${repo_name}/issues`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center">
                ...
                <li className={`d-inline-flex ${location.pathname === `/${username}/${repo_name}/pulls` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="projects-tab" to={`/${username}/${repo_name}/pulls`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center">
                ...
                <li className={`d-inline-flex ${location.pathname === `/${username}/${repo_name}/actions` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="packages-tab" to={`/${username}/${repo_name}/actions`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center">
                ...
                <li className={`d-inline-flex ${location.pathname === `/${username}/${repo_name}/projects?query=is%3Aopen` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="stars-tab" to={`/${username}/${repo_name}/projects?query=is%3Aopen`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center">
                ...
                <li className={`d-inline-flex ${location.pathname === `/${username}/${repo_name}/security` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="stars-tab" to={`/${username}/${repo_name}/security`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center">
                ...
                <li className={`d-inline-flex ${location.pathname === `/${username}/${repo_name}/pulse` ? 'nav-link-active' : 'nav-link '}`}>
                    <Link id="stars-tab" to={`/${username}/${repo_name}/pulse`} className="text-decoration-none d-flex gap-2 justify-content-center align-items-center">
